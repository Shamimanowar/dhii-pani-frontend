          ...
          <table className="data-table-table">
            <thead className="data-table-thead">
              <tr>
                ...
                <th className="data-table-th">TEMPERATURE{limits.temperature && (limits.temperature.min !== undefined || limits.temperature.max !== undefined) && <span className="data-table-th-range">{limits.temperature.min !== undefined && limits.temperature.max !== undefined ? `(${limits.temperature.min} - ${limits.temperature.max})` : limits.temperature.max !== undefined ? `(${limits.temperature.max})` : `(${limits.temperature.min})`}</span>}</th>
                <th className="data-table-th">BOD{limits.bod && (limits.bod.min !== undefined || limits.bod.max !== undefined) && <span className="data-table-th-range">{limits.bod.min !== undefined && limits.bod.max !== undefined ? `(${limits.bod.min} - ${limits.bod.max})` : limits.bod.max !== undefined ? `(${limits.bod.max})` : `(${limits.bod.min})`}</span>}</th>
                <th className="data-table-th">COD{limits.cod && (limits.cod.min !== undefined || limits.cod.max !== undefined) && <span className="data-table-th-range">{limits.cod.min !== undefined && limits.cod.max !== undefined ? `(${limits.cod.min} - ${limits.cod.max})` : limits.cod.max !== undefined ? `(${limits.cod.max})` : `(${limits.cod.min})`}</span>}</th>
                <th className="data-table-th">PH{limits.ph && (limits.ph.min !== undefined || limits.ph.max !== undefined) && <span className="data-table-th-range">{limits.ph.min !== undefined && limits.ph.max !== undefined ? `(${limits.ph.min} - ${limits.ph.max})` : limits.ph.max !== undefined ? `(${limits.ph.max})` : `(${limits.ph.min})`}</span>}</th>
                <th className="data-table-th">TDS{limits.tds && (limits.tds.min !== undefined || limits.tds.max !== undefined) && <span className="data-table-th-range">{limits.tds.min !== undefined && limits.tds.max !== undefined ? `(${limits.tds.min} - ${limits.tds.max})` : limits.tds.max !== undefined ? `(${limits.tds.max})` : `(${limits.tds.min})`}</span>}</th>
                <th className="data-table-th">DO{limits.do && (limits.do.min !== undefined || limits.do.max !== undefined) && <span className="data-table-th-range">{limits.do.min !== undefined && limits.do.max !== undefined ? `(${limits.do.min} - ${limits.do.max})` : limits.do.max !== undefined ? `(${limits.do.max})` : `(${limits.do.min})`}</span>}</th>
                <th className="data-table-th">COLOR{limits.color && (limits.color.min !== undefined || limits.color.max !== undefined) && <span className="data-table-th-range">{limits.color.min !== undefined && limits.color.max !== undefined ? `(${limits.color.min} - ${limits.color.max})` : limits.color.max !== undefined ? `(${limits.color.max})` : `(${limits.color.min})`}</span>}</th>
                <th className="data-table-th">TSS{limits.tss && (limits.tss.min !== undefined || limits.tss.max !== undefined) && <span className="data-table-th-range">{limits.tss.min !== undefined && limits.tss.max !== undefined ? `(${limits.tss.min} - ${limits.tss.max})` : limits.tss.max !== undefined ? `(${limits.tss.max})` : `(${limits.tss.min})`}</span>}</th>
              </tr>
            </thead>
