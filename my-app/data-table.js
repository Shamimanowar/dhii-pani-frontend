    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{ fontWeight: 600, fontSize: 15, marginBottom: 8, color: '#6c63ff' }}>Export Options:</span>
          <div style={{ display: 'flex', gap: 10 }}>
            <button style={headerBtnStyle} onClick={handleExportCSV}>Export CSV</button>
            <button style={headerBtnStyle} onClick={handleExportExcel}>Export Excel</button>
          </div>
        </div>
      </div>
      {/* Header Buttons */}
      ...
      <div style={{
        ...
        <span>This table always uses data from tableData.js. To update, edit tableData.js.</span>
      </div>
    </div>
  );
}
